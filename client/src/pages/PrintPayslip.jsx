...
const PrintPayslip = () => {
  ...
  return (
    <div className="max-w-2xl mx-auto bg-white animate-fade-in dark:bg-white mt-6">
      <div className="text-center border-slate-200 pb-6 mb-8">
        <h1
          className="
        ...
        <table className="w-full text-sm">
          <thead>
            <tr className="bg-slate-50">
              <th className="text-left px-4 py-4 text-xs text-slate-500 uppercase tracking-wider">
                Description
              </th>
              <th className="text-right px-4 py-4 text-xs text-slate-500 uppercase tracking-wider">
                Amount
              </th>
            </tr>
          </thead>
